...
def test_get_users_normal_user_me(client: TestClient, normal_user_token_headers):
    """Test getting current normal user."""
...
def test_create_user_new_email(client: TestClient, superuser_token_headers, db: Session):
...
def test_get_existing_user(client: TestClient, superuser_token_headers, db: Session):
