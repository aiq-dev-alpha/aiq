...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const defaultTheme: CardTheme = {
      background: 'linear-gradient(135deg, #365314 0%, #3f6212 50%, #4d7c0f 100%)',
      foreground: '#ecfccb',
      border: '#84cc16',
      accent: '#a3e635',
...
.card--elevated {
  box-shadow: 0 16px 35px -7px var(--card-shadow);
...
.card--glass {
  background: rgba(235, 219, 262, 0.68);
...
.card--neumorphic {
  background: #84cc16;
  box-shadow:
    12px 12px 28px rgba(132, 204, 22, 0.3),
...
.card__overlay {
  position: absolute;
  inset: 0;
  background: linear-gradient(to top, rgba(132, 204, 22, 0.3, 0.8) 0%, transparent 100%);
  display: flex;
