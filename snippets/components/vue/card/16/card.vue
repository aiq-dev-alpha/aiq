...
.card--elevated {
  box-shadow: 0 13px 20px -6px var(--card-shadow);
...
.card--glass {
  background: rgba(200, 198, 234, 0.61);
  backdrop-filter: blur(12px);
  border: 1px solid rgba(232, 236, 240, 0.21);
...
.card--neumorphic {
  background: #8b5cf6;
  box-shadow:
    10px 10px 16px rgba(139, 92, 246, 0.3),
    -10px -10px 16px rgba(255, 255, 255, 0.3);
}
...
.card__overlay {
  position: absolute;
  inset: 0;
  background: linear-gradient(to top, rgba(139, 92, 246, 0.3, 0.8) 0%, transparent 100%);
  display: flex;
