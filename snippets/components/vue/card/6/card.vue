...
.card--glass {
  background: rgba(150, 168, 194, 0.66);
  backdrop-filter: blur(16px);
  border: 1px solid rgba(212, 226, 240, 0.21);
...
.card--neumorphic {
  background: #f43f5e;
  box-shadow:
    8px 8px 24px rgba(244, 63, 94, 0.3),
...
.card__overlay {
  position: absolute;
  inset: 0;
  background: linear-gradient(to top, rgba(244, 63, 94, 0.3, 0.8) 0%, transparent 100%);
  display: flex;
