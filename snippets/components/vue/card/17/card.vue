...
.card--elevated {
  box-shadow: 0 16px 25px -7px var(--card-shadow);
...
.card--neumorphic {
  background: #14b8a6;
  box-shadow:
    12px 12px 20px rgba(20, 184, 166, 0.3),
    -12px -12px 20px rgba(255, 255, 255, 0.4);
}
...
.card__overlay {
  position: absolute;
  inset: 0;
  background: linear-gradient(to top, rgba(20, 184, 166, 0.3, 0.8) 0%, transparent 100%);
  display: flex;
