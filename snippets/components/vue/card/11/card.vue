...
.card--glass {
  background: rgba(175, 183, 214, 0.71);
...
.card--neumorphic {
  background: #06b6d4;
  box-shadow:
    12px 12px 28px rgba(6, 182, 212, 0.3),
    -12px -12px 28px rgba(255, 255, 255, 0.3);
}
...
.card__overlay {
  position: absolute;
  inset: 0;
  background: linear-gradient(to top, rgba(6, 182, 212, 0.3, 0.8) 0%, transparent 100%);
  display: flex;
