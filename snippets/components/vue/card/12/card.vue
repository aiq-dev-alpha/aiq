...
.card--glass {
  background: rgba(180, 186, 218, 0.72);
  backdrop-filter: blur(12px);
  border: 1px solid rgba(224, 232, 240, 0.17);
...
.card--neumorphic {
  background: #eab308;
  box-shadow:
    8px 8px 16px rgba(234, 179, 8, 0.3),
...
.card__overlay {
  position: absolute;
  inset: 0;
  background: linear-gradient(to top, rgba(234, 179, 8, 0.3, 0.8) 0%, transparent 100%);
  display: flex;
