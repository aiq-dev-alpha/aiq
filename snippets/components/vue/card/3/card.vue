...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const defaultTheme: CardTheme = {
      background: 'linear-gradient(135deg, #134e4a 0%, #14532d 50%, #365314 100%)',
      foreground: '#ecfdf5',
      border: '#10b981',
      accent: '#34d399',
...
.card--elevated {
  box-shadow: 0 10px 35px -5px var(--card-shadow);
...
.card--glass {
  background: rgba(135, 159, 182, 0.63);
  backdrop-filter: blur(18px);
  border: 1px solid rgba(206, 223, 240, 0.18);
...
.card--neumorphic {
  background: #10b981;
  box-shadow:
    8px 8px 28px rgba(16, 185, 129, 0.3),
...
.card__overlay {
  position: absolute;
  inset: 0;
  background: linear-gradient(to top, rgba(16, 185, 129, 0.3, 0.8) 0%, transparent 100%);
  display: flex;
