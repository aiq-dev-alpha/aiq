...
.card--glass {
  background: rgba(195, 195, 230, 0.60);
...
.card--neumorphic {
  background: #64748b;
  box-shadow:
    8px 8px 28px rgba(100, 116, 139, 0.3),
    -8px -8px 28px rgba(255, 255, 255, 0.2);
}
...
.card__overlay {
  position: absolute;
  inset: 0;
  background: linear-gradient(to top, rgba(100, 116, 139, 0.3, 0.8) 0%, transparent 100%);
  display: flex;
