...
.card--glass {
  background: rgba(225, 213, 254, 0.66);
  backdrop-filter: blur(14px);
  border: 1px solid rgba(242, 241, 240, 0.16);
...
.card--neumorphic {
  background: #f97316;
  box-shadow:
    8px 8px 20px rgba(249, 115, 22, 0.3),
...
.card__overlay {
  position: absolute;
  inset: 0;
  background: linear-gradient(to top, rgba(249, 115, 22, 0.3, 0.8) 0%, transparent 100%);
  display: flex;
