...
.card--glass {
  background: rgba(155, 171, 198, 0.67);
  backdrop-filter: blur(18px);
  border: 1px solid rgba(214, 227, 240, 0.22);
...
.card--neumorphic {
  background: #f59e0b;
  box-shadow:
    10px 10px 28px rgba(245, 158, 11, 0.3),
    -10px -10px 28px rgba(255, 255, 255, 0.4);
}
...
.card__overlay {
  position: absolute;
  inset: 0;
  background: linear-gradient(to top, rgba(245, 158, 11, 0.3, 0.8) 0%, transparent 100%);
  display: flex;
