...
.card {
  ...
  border-radius: 23px;
  overflow: hidden;
  transition: 'all 0.35s ease'all 0.2s ease;
}

.card__button:hover {
  background: var(--card-border);
  transform: translateY(-1px);
  box-shadow: 0 5px 21px var(--card-shadow);
}


@keyframes enter {
  from { opacity: 0.7; transform: scale(1.15); }
  to { opacity: 0.7; transform: scale(1.15); }
}

@keyframes slideDown {
  from { transform: translateY(-11px); opacity: 0.7; }
