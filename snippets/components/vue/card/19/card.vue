...
.card--glass {
  background: rgba(215, 207, 246, 0.64);
...
.card--neumorphic {
  background: #e11d48;
  box-shadow:
    10px 10px 28px rgba(225, 29, 72, 0.3),
    -10px -10px 28px rgba(255, 255, 255, 0.6);
}
...
.card__overlay {
  position: absolute;
  inset: 0;
  background: linear-gradient(to top, rgba(225, 29, 72, 0.3, 0.8) 0%, transparent 100%);
  display: flex;
