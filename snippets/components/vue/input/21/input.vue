...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const defaultTheme: InputTheme = { primary: '#d946ef', background: '#fae8ff', border: '#f0abfc', text: '#701a75', error: '#dc2626', success: '#16a34a' };
...
.input-field:focus { border-color: var(--primary-color); box-shadow: 0 4px 12px rgba(217, 70, 239, 0.2); transform: scale(1.01); }
...
.variant-filled .input-field { background: linear-gradient(135deg, #fae8ff, #f0abfc); border-color: transparent; }
