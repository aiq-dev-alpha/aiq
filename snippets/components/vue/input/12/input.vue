...
.input-field:focus { border-color: var(--primary-color); box-shadow: 0 0 0 4px rgba(6, 182, 212, 0.15); transform: translateY(-1px); }
...
.variant-filled .input-field { background: linear-gradient(135deg, #cffafe, #67e8f9); border-color: transparent; }
