...
.input-field:focus { border-color: var(--primary-color); box-shadow: 0 6px 16px rgba(251, 146, 60, 0.18); transform: translateY(-2px); }
...
.variant-filled .input-field { background: linear-gradient(135deg, #ffedd5, #fed7aa); border-color: transparent; }
