...
.input-field { width: 100%; font-family: inherit; font-size: 1rem; color: var(--text-color); background-color: var(--bg-color); border: 3px dotted var(--border-color); border-radius: 0.5rem; transition: all 0.3s ease; outline: none; }
.input-field:focus { border-style: solid; border-color: var(--primary-color); box-shadow: 0 0 0 4px rgba(16, 185, 129, 0.1); }
.has-error .input-field { border-color: var(--error-color); border-style: solid; }
...
.variant-filled .input-field { background: linear-gradient(to right, #d1fae5, #a7f3d0); border-style: solid; border-color: transparent; }
.variant-underlined .input-field { border: none; border-bottom: 3px dotted var(--border-color); border-radius: 0; background: transparent; }
.variant-underlined .input-field:focus { border-bottom-style: solid; }
.input-icon { position: absolute; color: var(--primary-color); pointer-events: none; }
.input-icon.left { left: 1rem; }
.input-icon.right { right: 1rem; }
.clear-button { position: absolute; right: 1rem; background: var(--primary-color); color: white; border: none; border-radius: 0.25rem; padding: 0.25rem 0.5rem; cursor: pointer; transition: all 0.2s; }
.clear-button:hover { background: #059669; }
...
.helper-text { color: #065f46; }
.character-counter { color: #059669; margin-left: auto; }
