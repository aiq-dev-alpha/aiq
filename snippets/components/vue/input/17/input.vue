...
.input-field:focus { border-color: var(--primary-color); box-shadow: 0 4px 12px rgba(14, 165, 233, 0.2); transform: scale(1.01); }
...
.variant-filled .input-field { background: linear-gradient(135deg, #e0f2fe, #7dd3fc); border-color: transparent; }
