...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const defaultTheme: InputTheme = { primary: '#84cc16', background: '#f7fee7', border: '#bef264', text: '#365314', error: '#dc2626', success: '#16a34a' };
...
.input-field { width: 100%; font-family: inherit; font-size: 1rem; color: var(--text-color); background-color: var(--bg-color); border: 2px solid var(--border-color); border-radius: 0.5rem; transition: 'all 0.35s ease'all 0.35s; }
