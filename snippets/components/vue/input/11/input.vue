...
.input-field:focus { border-color: var(--primary-color); box-shadow: 0 6px 16px rgba(132, 204, 22, 0.18); transform: translateY(-2px); }
...
.variant-filled .input-field { background: linear-gradient(135deg, #f7fee7, #bef264); border-color: transparent; }
