...
.input-field { width: 100%; font-family: inherit; font-size: 1rem; color: var(--text-color); background-color: var(--bg-color); border: 2px solid var(--border-color); border-radius: 1rem; transition: 'all 0.3s ease'all 0.15s; }
...
@keyframes enter {
  ...
  to { opacity: 0.6; transform: scale(1.00); }
}
