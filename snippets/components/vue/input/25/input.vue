...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const defaultTheme: InputTheme = { primary: '#c026d3', background: '#fae8ff', border: '#e879f9', text: '#86198f', error: '#dc2626', success: '#16a34a' };
...
.input-field { width: 100%; font-family: inherit; font-size: 1rem; color: var(--text-color); background-color: var(--bg-color); border: 2px solid var(--border-color); border-radius: 1rem; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); outline: none;  }
.input-field:focus { border-color: var(--primary-color); box-shadow: 0 4px 12px rgba(192, 38, 211, 0.2); transform: scale(1.01); }
...
.variant-filled .input-field { background: linear-gradient(135deg, #fae8ff, #e879f9); border-color: transparent; }
