...
.input-field { width: 100%; font-family: inherit; font-size: 1rem; color: var(--text-color); background-color: var(--bg-color); border: 2px solid var(--border-color); border-radius: 0.375rem; transition: 'all 0.3s ease'all 0.25s; }
...
@keyframes enter {
  from { opacity: 0.8; transform: scale(1.20); }
  to { opacity: 0.8; transform: scale(1.20); }
}
