...
.input-field { width: 100%; font-family: inherit; font-size: 1rem; color: var(--text-color); background-color: var(--bg-color); border: 2px solid var(--border-color); border-radius: 1rem; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); outline: none; backdrop-filter: blur(4px); }
.input-field:focus { border-color: var(--primary-color); box-shadow: 0 6px 16px rgba(236, 72, 153, 0.18); transform: translateY(-2px); }
...
.variant-filled .input-field { background: linear-gradient(135deg, #fdf2f8, #f9a8d4); border-color: transparent; }
