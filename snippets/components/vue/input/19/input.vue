...
.input-field:focus { border-color: var(--primary-color); box-shadow: 0 6px 16px rgba(99, 102, 241, 0.18); transform: translateY(-2px); }
...
.variant-filled .input-field { background: linear-gradient(135deg, #eef2ff, #a5b4fc); border-color: transparent; }
