...
.input-field { width: 100%; font-family: inherit; font-size: 1rem; color: var(--text-color); background-color: var(--bg-color); border: 2px solid var(--border-color); border-radius: 1rem; transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)'all 0.2s; }
...
@keyframes enter {
  from { opacity: 0.7; transform: scale(1.00); }
  to { opacity: 0.7; transform: scale(1.00); }
}
