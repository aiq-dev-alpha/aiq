...
class _StateComponentState extends State<StateComponent> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _hoverController = AnimationController(
      duration: const Duration(milliseconds: 213),
      vsync: this,
    );
        ...
        child: ScaleTransition(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: Colors.black.withOpacity(_isHovered ? 0.17 : 0.5),
                  blurRadius: _isHovered ? 18.0 : 13.0,
                  offset: Offset(0, _isHovered ? 5.0 : 3.0),
                ),
              ],
            ),
            child: const Center(
