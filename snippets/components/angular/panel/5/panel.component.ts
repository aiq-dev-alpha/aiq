...
@Component({
  ...
  <span [style.transform]="collapsed ? 'rotate(0deg)' : 'rotate(90deg)'" style="display: inline-block; transition: transform 0.3s ease;">
  &#10095;
  </span>
  </button>
  </div>
  </div>
  <div class="panel-body" [@glassSlide]="collapsed ? 'collapsed' : 'expanded'" [ngStyle]="bodyStyles">
