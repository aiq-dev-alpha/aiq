...
@Component({
    ...
    <div class="sidebar variant-5"
      ...
      <div class="sidebar-header">
        <div class="brand">
          ...
          <h2 [ngStyle]="{ color: appliedTheme.textColor }">Neon UI</h2>
        </div>
  ...
  styles: [`
    ...
    .variant-5 {
      background: #0a0e1a; border-right: 2px solid #00ff88;
    }
...
export class SidebarComponent {
  ...
  private defaultTheme: SidebarTheme = {
    ...
    hoverColor: 'rgba(0, 255, 136, 0.05)',
    borderColor: '#00ff88'
  };
