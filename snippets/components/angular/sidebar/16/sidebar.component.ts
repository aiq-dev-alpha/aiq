...
@Component({
    ...
    <div class="sidebar variant-16"
      ...
      <div class="sidebar-header">
        <div class="brand">
          ...
          <h2 [ngStyle]="{ color: appliedTheme.textColor }">Lime</h2>
        </div>
  ...
  styles: [`
    ...
    .variant-16 {
      background: linear-gradient(180deg, #365314 0%, #3f6212 100%);
    }
...
export class SidebarComponent {
  ...
  private defaultTheme: SidebarTheme = {
    ...
    textColor: '#ecfccb',
    activeColor: 'rgba(132, 204, 22, 0.25)',
    hoverColor: 'rgba(132, 204, 22, 0.15)',
