...
@Component({
    ...
    <div class="sidebar variant-24"
      ...
      <div class="sidebar-header">
        <div class="brand">
          ...
          <h2 [ngStyle]="{ color: appliedTheme.textColor }">Sunlight</h2>
        </div>
  ...
  styles: [`
    ...
    .variant-24 {
      background: linear-gradient(180deg, #713f12 0%, #854d0e 100%);
    }
...
export class SidebarComponent {
  ...
  private defaultTheme: SidebarTheme = {
    ...
    hoverColor: 'rgba(234, 179, 8, 0.15)',
