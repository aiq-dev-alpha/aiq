...
@Component({
    ...
    <div class="sidebar variant-28"
      ...
      <div class="sidebar-header">
        <div class="brand">
          ...
          <h2 [ngStyle]="{ color: appliedTheme.textColor }">Magenta</h2>
        </div>
  ...
  styles: [`
    ...
    .variant-28 {
      background: linear-gradient(180deg, #701a75 0%, #a21caf 100%);
    }
...
export class SidebarComponent {
  ...
  private defaultTheme: SidebarTheme = {
    ...
    textColor: '#fae8ff',
    activeColor: 'rgba(232, 121, 249, 0.25)',
    hoverColor: 'rgba(232, 121, 249, 0.15)',
