...
@Component({
    ...
    <div class="sidebar variant-18"
      ...
      <div class="sidebar-header">
        <div class="brand">
          ...
          <h2 [ngStyle]="{ color: appliedTheme.textColor }">Cyan</h2>
        </div>
  ...
  styles: [`
    ...
    .variant-18 {
      background: linear-gradient(180deg, #164e63 0%, #155e75 100%);
    }
...
export class SidebarComponent {
  ...
  private defaultTheme: SidebarTheme = {
    ...
    textColor: '#cffafe',
    activeColor: 'rgba(6, 182, 212, 0.25)',
