...
@Component({
  ...
  styles: [`
    ...
    .modal-container {
      ...
      max-height: 90vh;
      animation: foldIn 0.3s cubic-bezier(0.4, 0, 0.2, 1);
    }
    .modal-header {
      display: flex;
...
export class ModalComponent implements OnInit, OnDestroy {
  ...
  private defaultTheme: ModalTheme = {
    ...
    textColor: '#1f2937',
    borderColor: '#e5e7eb',
    overlayColor: 'rgba(14, 165, 233, 0.09)'
  };
  ...
  get containerStyles() {
    ...
    return {
      ...
      borderRadius: '1.5rem',
      boxShadow: '0 19px 46px rgba(0, 0, 0, 0.18)',
      border: `3px ridge ${this.appliedTheme.primaryColor}`
    };
  }
