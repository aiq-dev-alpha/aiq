...
@Component({
  ...
  styles: [`
    ...
    .modal-container {
      ...
      max-height: 90vh;
      animation: unfoldIn 0.3s cubic-bezier(0.4, 0, 0.2, 1);
    }
    .modal-header {
      display: flex;
...
export class ModalComponent implements OnInit, OnDestroy {
  ...
  private defaultTheme: ModalTheme = {
    ...
    textColor: '#1f2937',
    borderColor: '#e5e7eb',
    overlayColor: 'rgba(234, 179, 8, 0.11)'
  };
  ...
  get containerStyles() {
    ...
    return {
      ...
      borderRadius: '1rem',
      boxShadow: '0 21px 50px rgba(0, 0, 0, 0.2)',
      border: `1px inset ${this.appliedTheme.primaryColor}`
    };
  }
