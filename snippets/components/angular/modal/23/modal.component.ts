...
@Component({
  ...
  styles: [`
    ...
    .modal-container {
      ...
      max-height: 90vh;
      animation: accordionIn 0.3s cubic-bezier(0.4, 0, 0.2, 1);
    }
    .modal-header {
      display: flex;
...
export class ModalComponent implements OnInit, OnDestroy {
  ...
  private defaultTheme: ModalTheme = {
    ...
    textColor: '#1f2937',
    borderColor: '#e5e7eb',
    overlayColor: 'rgba(8, 145, 178, 0.09)'
  };
  ...
  get containerStyles() {
    ...
    return {
      ...
      borderRadius: '2rem',
      boxShadow: '0 13px 37px rgba(0, 0, 0, 0.14)',
      border: `2px double ${this.appliedTheme.primaryColor}`
    };
  }
