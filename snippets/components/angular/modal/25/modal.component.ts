...
@Component({
  ...
  styles: [`
    ...
    .modal-container {
      ...
      max-height: 90vh;
      animation: portalIn 0.3s cubic-bezier(0.4, 0, 0.2, 1);
    }
    .modal-header {
      display: flex;
...
export class ModalComponent implements OnInit, OnDestroy {
  ...
  private defaultTheme: ModalTheme = {
    ...
    textColor: '#1f2937',
    borderColor: '#e5e7eb',
    overlayColor: 'rgba(219, 39, 119, 0.13)'
  };
  ...
  get containerStyles() {
    ...
    return {
      ...
      borderRadius: '1.5rem',
      boxShadow: '0 27px 57px rgba(0, 0, 0, 0.24)',
      border: `2px ridge ${this.appliedTheme.primaryColor}`
    };
  }
