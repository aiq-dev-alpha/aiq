...
@Component({
  ...
  styles: [`
    ...
    .modal-container {
      ...
      max-height: 90vh;
      animation: curtainIn 0.3s cubic-bezier(0.4, 0, 0.2, 1);
    }
    .modal-header {
      display: flex;
...
export class ModalComponent implements OnInit, OnDestroy {
  ...
  private defaultTheme: ModalTheme = {
    ...
    textColor: '#1f2937',
    borderColor: '#e5e7eb',
    overlayColor: 'rgba(234, 88, 12, 0.11)'
  };
  ...
  get containerStyles() {
    ...
    return {
      ...
      boxShadow: '0 11px 35px rgba(0, 0, 0, 0.13)',
      border: `3px double ${this.appliedTheme.primaryColor}`
    };
  }
