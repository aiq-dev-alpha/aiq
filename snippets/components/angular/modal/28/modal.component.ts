...
@Component({
  ...
  styles: [`
    ...
    .modal-container {
      ...
      max-height: 90vh;
      animation: revealIn 0.3s cubic-bezier(0.4, 0, 0.2, 1);
    }
    .modal-header {
      display: flex;
...
export class ModalComponent implements OnInit, OnDestroy {
  ...
  private defaultTheme: ModalTheme = {
    ...
    textColor: '#1f2937',
    borderColor: '#e5e7eb',
    overlayColor: 'rgba(101, 163, 13, 0.07)'
  };
  ...
  get containerStyles() {
    ...
    return {
      ...
      boxShadow: '0 31px 63px rgba(0, 0, 0, 0.27)',
      border: `2px dotted ${this.appliedTheme.primaryColor}`
    };
  }
