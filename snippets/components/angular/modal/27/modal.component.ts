...
@Component({
  ...
  styles: [`
    ...
    .modal-container {
      ...
      max-height: 90vh;
      animation: sweepIn 0.3s cubic-bezier(0.4, 0, 0.2, 1);
    }
    .modal-header {
      display: flex;
...
export class ModalComponent implements OnInit, OnDestroy {
  ...
  private defaultTheme: ModalTheme = {
    ...
    textColor: '#1f2937',
    borderColor: '#e5e7eb',
    overlayColor: 'rgba(13, 148, 136, 0.08)'
  };
  ...
  get containerStyles() {
    ...
    return {
      ...
      boxShadow: '0 18px 43px rgba(0, 0, 0, 0.18)',
      border: `1px dashed ${this.appliedTheme.primaryColor}`
    };
  }
