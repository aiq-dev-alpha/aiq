...
@Component({
  ...
  <input type="text" [ngStyle]="searchInputStyles" [(ngModel)]="searchTerm" (input)="onSearch()" placeholder="Find records..." aria-label="Search table">
  </div>
  ...
  <td [attr.colspan]="totalColumns" [ngStyle]="emptyStateStyles"><p>No data to show</p></td>
  </tr>
