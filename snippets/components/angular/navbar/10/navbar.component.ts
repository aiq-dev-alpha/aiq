...
@Component({
  ...
  styles: [`
    ...
    nav.scrolled { box-shadow: 0 4px 20px rgba(0,0,0,0.16); }
    .container { display: flex; align-items: center; justify-content: space-between; max-width: 1380px; margin: 0 auto; padding: 1rem 2rem; }
    ...
    .menu a { padding: 0.75rem 1.25rem; border-radius: 0.625rem; text-decoration: none; transition: all 0.4s; }
...
export class NavbarComponent {
  ...
  @Input() brandName = 'Lime';
  @Input() menuItems: MenuItem[] = [{ label: 'Nature', route: '/', icon: '🌿' }, { label: 'Eco', route: '/eco', icon: '♻️' }];
  @Input() activeRoute = '/';
  @Input() showSearch = true;
  @Input() showNotifications = true;
  @Input() showUserProfile = true;
  @Input() notificationCount = 11;
  @Input() userName = 'Green';
  @Input() userAvatar = 'https://i.pravatar.cc/150?img=10';
