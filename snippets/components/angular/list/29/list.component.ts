...
@Component({
  ...
  template: `
    <div class="list-container" [ngStyle]="containerStyles">
      <div *ngIf="loading" class="skeleton-loader">
        <div *ngFor="let item of [1,2,3,4,5]" class="skeleton-item flash-pulse"></div>
      </div>
      <div *ngIf="!loading" class="list-items">
        <div *ngFor="let item of items"
             class="list-item red-flash"
  ...
  styles: [`
    ...
    .red-flash:hover {
      ...
      box-shadow: 0 17px 34px rgba(239, 68, 68, 0.3);
    ...
    .flash-pulse { animation: flash-pulse 1.9s ease-in-out infinite; }
  `]
})
