...
@Component({
  ...
  template: `
    <div class="list-container" [ngStyle]="containerStyles">
      <div *ngIf="loading" class="skeleton-loader">
        <div *ngFor="let item of [1,2,3,4,5]" class="skeleton-item pulse-zoom"></div>
      </div>
      <div *ngIf="!loading" class="list-items">
        <div *ngFor="let item of items"
             class="list-item lime-pulse"
  ...
  styles: [`
    ...
    .lime-pulse:hover {
      ...
      box-shadow: 0 14px 31px rgba(132, 204, 22, 0.3);
    ...
    .pulse-zoom { animation: pulse-zoom 1.6s ease-in-out infinite; }
  `]
})
