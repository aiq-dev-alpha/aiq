...
@Component({
  ...
  template: `
    <div class="list-container" [ngStyle]="containerStyles">
      <div *ngIf="loading" class="skeleton-loader">
        <div *ngFor="let item of [1,2,3,4,5]" class="skeleton-item slide-flip"></div>
      </div>
      <div *ngIf="!loading" class="list-items">
        <div *ngFor="let item of items"
             class="list-item indigo-flip"
  ...
  styles: [`
    ...
    .indigo-flip:hover {
      ...
      box-shadow: 0 10px 27px rgba(99, 102, 241, 0.3);
    ...
    .slide-flip { animation: slide-flip 1.7s ease-in-out infinite; }
  `]
})
