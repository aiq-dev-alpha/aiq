...
@Component({
  ...
  template: `
    <button
      ...
      class="zoom-button">
      <span *ngIf="loading" class="spinner wavy-spinner"></span>
  ...
  styles: [`
    .zoom-button {
      ...
      align-items: center;
      gap: 0.5rem;
      box-shadow: 0 5px 20px #0891b266;
    }

    .zoom-button:hover:not(:disabled) {
      box-shadow: 0 8px 35px #0891b299;
      transform: translateY(-2px) scale(1.02);
      animation: zoomAnim 0.5s ease;
    }
...
export class ButtonComponent {
  ...
  @Input() variant: 'default' | 'outlined' | 'filled' | 'zoom' = 'default';
