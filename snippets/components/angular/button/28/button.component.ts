...
@Component({
  ...
  template: `
    <button
      ...
      class="lift-button">
      <span *ngIf="loading" class="spinner spiral-spinner"></span>
  ...
  styles: [`
    .lift-button {
      ...
      align-items: center;
      gap: 0.5rem;
      box-shadow: 0 5px 20px #b91c1c66;
    }

    .lift-button:hover:not(:disabled) {
      box-shadow: 0 8px 35px #b91c1c99;
      transform: translateY(-2px) scale(1.02);
      animation: liftAnim 0.5s ease;
    }
...
export class ButtonComponent {
  ...
  @Input() variant: 'default' | 'outlined' | 'filled' | 'lift' = 'default';
