...
@Component({
  ...
  template: `
    <button
      ...
      class="swing-button">
      <span *ngIf="loading" class="spinner plus-spinner"></span>
  ...
  styles: [`
    .swing-button {
      ...
      align-items: center;
      gap: 0.5rem;
      box-shadow: 0 5px 20px #15803d66;
    }

    .swing-button:hover:not(:disabled) {
      box-shadow: 0 8px 35px #15803d99;
      transform: translateY(-2px) scale(1.02);
      animation: swingAnim 0.5s ease;
    }

    .swing-button:active:not(:disabled) {
...
export class ButtonComponent {
  ...
  @Input() variant: 'default' | 'outlined' | 'filled' | 'swing' = 'default';
