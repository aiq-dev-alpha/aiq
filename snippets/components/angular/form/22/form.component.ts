...
export class FormComponent {
  ...
  @Input() title: string = 'Form Variant 22';
  @Input() description: string = 'Unique form design 22';
  @Input() fields: any[] = [
  ...
  getInputStyles(fieldName: string) {
    ...
    return {
      padding: '0.75rem',
      border: 'none',
      borderBottom: `2px solid ${isInvalid ? this.appliedTheme.errorColor : this.appliedTheme.borderColor}`,
      borderRadius: '0',
      fontSize: '1rem',
      color: this.appliedTheme.textColor,
