...
export const Component: React.FC<ComponentProps> = ({
  ...
  theme = {},
  className = '',
  presetColors = ['#8b5cf6', '#f59e0b', '#f59e0b', '#ef4444', '#8b5cf6']
}) => {
  const [internalValue, setInternalValue] = useState('#8b5cf6');
  ...
  return (
    <div className={className} style={{ display: 'flex', flexDirection: 'column', gap: '18px', maxWidth: '300px' }}>
      <input
        type="color"
        value={value}
