...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-full shadow-sm overflow-hidden hover:shadow-sm transition-shadow-sm duration-150">
      ...
      <div className="p-4">
        ...
        {onAddToCart && (
          <button
            onClick={onAddToCart}
            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 rounded-full transition-colors"
          >
            Add to Cart
          </button>
        )}
