...
export const ProfileCard: React.FC<ProfileCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow-2xl overflow-hidden max-w-sm">
      ...
      <div className="px-6 pb-6">
        <div className="relative -mt-16 mb-4">
          <img
            src={avatar}
            alt={name}
            className="w-32 h-32 rounded-lg border-4 border-white shadow-2xl object-cover mx-auto"
          />
        </div>
