...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-full shadow-md overflow-hidden hover:shadow-md transition-shadow-md duration-300">
      <div className="relative group">
        ...
        {discount > 0 && (
          <span className="absolute top-3 right-3 px-2 py-1 bg-pink-600 text-white text-xs font-bold rounded-full">
            -{discount}%
          </span>
        )}
      </div>
      ...
      <div className="p-4">
        ...
        {onAddToCart && (
          <button
            onClick={onAddToCart}
            className="w-full bg-pink-600 hover:bg-pink-700 text-white font-medium py-2.5 rounded-full transition-colors"
          >
            Add to Cart
          </button>
        )}
