...
export const Component: React.FC<ComponentProps> = ({ theme = {}, className = '', onInteract }) => {
  ...
  return (
    <div
      ...
      style={{
        padding: '19px 29px',
        background: active ? `linear-gradient(210deg, ${primary}, ${primary}dd)` : '#ffffff',
        ...
        fontWeight: 800,
        cursor: 'pointer',
        transition: 'all 325ms cubic-bezier(0.2, 2.9, 0.64, 1)',
        boxShadow: active ? `0 15px 29px ${primary}40` : `0 3px 13px rgba(0,0,0,0.7)`,
