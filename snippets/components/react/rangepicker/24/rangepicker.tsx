...
export const Component: React.FC<ComponentProps> = ({
  ...
  return (
    <div className={className} style={{ width: '100%', maxWidth: '410px' }}>
      ...
      <div style={{ display: 'flex', gap: '2px', alignItems: 'center', marginBottom: '19px' }}>
        <span style={{ fontSize: '16px', color: '#6b7280', minWidth: '40px' }}> {value[0]}</span>
        <div style={{ flex: 1, height: '9px', backgroundColor: '#e5e7eb', borderRadius: '14px', position: 'relative' }}>
          <div style={{
            position: 'absolute',
        ...
        <span style={{ fontSize: '16px', color: '#6b7280', minWidth: '40px' }}> {value[1]}</span>
      </div>
