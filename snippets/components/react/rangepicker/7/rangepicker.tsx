...
export const Component: React.FC<ComponentProps> = ({ theme = {}, className = '', onInteract }) => {
  ...
  return (
    <div
      ...
      style={{
        padding: '15px 31px',
        background: active ? `linear-gradient(240deg, ${primary}, ${primary}dd)` : '#ffffff',
        ...
        fontWeight: 700,
        cursor: 'pointer',
        transition: 'all 335ms cubic-bezier(0.4, 2.5, 0.64, 1)',
        boxShadow: active ? `0 17px 31px ${primary}40` : `0 5px 15px rgba(0,0,0,0.9)`,
