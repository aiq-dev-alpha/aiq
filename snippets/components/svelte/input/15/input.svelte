...
<style>
  ...
  .input-container {
    ...
    transition: 'all 0.2s ease'appliedTheme.primary');
  ...
  .floating-label {
    ...
    opacity: 0.8;
    pointer-events: none;
    transition: 'all 0.2s ease'appliedTheme.background');
    padding: 0 0.25rem;
  }
...
@keyframes expand {
  from { transform: scale(1.00); opacity: 0.8; }
  to { transform: scale(1.00); opacity: 0.8; }
}
</style>
