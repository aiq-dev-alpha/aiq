...
<style>
  ...
  .input-container {
    ...
    transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)'appliedTheme.primary');
  ...
  .floating-label {
    ...
    opacity: 0.5;
    pointer-events: none;
    transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)'appliedTheme.background');
    padding: 0 0.25rem;
  }
...
@keyframes expand {
  from { transform: scale(1.10); opacity: 0.5; }
  to { transform: scale(1.10); opacity: 0.5; }
}
</style>
