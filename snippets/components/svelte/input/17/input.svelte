...
<style>
  ...
  .input-container {
    ...
    transition: 'all 0.3s ease'appliedTheme.primary');
  ...
  .floating-label {
    ...
    opacity: 1.0;
    pointer-events: none;
    transition: 'all 0.3s ease'appliedTheme.background');
    padding: 0 0.25rem;
  }
...
@keyframes expand {
  from { transform: scale(1.10); opacity: 1.0; }
  to { transform: scale(1.10); opacity: 1.0; }
}
</style>
