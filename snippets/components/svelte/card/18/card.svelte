<script lang="ts">
  ...
  // Variant 18: Stone Minimal
  const defaultTheme: CardTheme = {
    background: 'linear-gradient(to bottom, #fafaf9 0%, #e7e5e4 100%)',
    foreground: '#44403c',
    border: '#a8a29e',
    accent: '#78716c',
...
<style>
  .card {
    ...
    overflow: hidden;
    transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)'all 0.4s ease;
  }
